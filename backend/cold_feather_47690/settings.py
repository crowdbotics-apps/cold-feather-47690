"""
Django settings for cold_feather_47690 project.
...
ROOT_URLCONF = 'cold_feather_47690.urls'
...
WSGI_APPLICATION = 'cold_feather_47690.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_feather_47690 API",
    "DESCRIPTION": "API documentation for cold_feather_47690 App",
    "VERSION": "v1",
}
